 ...
 */
class TaskAdapter(
    private var mContext: Context, private var lists: List<TaskBean>,
    private val itemRes: Int = android.R.layout.simple_dropdown_item_1line
) :
    ArrayAdapter<TaskBean>(mContext, itemRes) {

    override fun getItem(position: Int): TaskBean? = lists[position]
