package com.phz.dev.feature.practice.mlkit.scan.core
...
class ScanOverlay(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    init {
        ...
        paint.strokeWidth = 3.toPx().toFloat()
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        resultRect?.let {rect->
            canvas?.drawCircle(rect.left + (rect.right - rect.left)/2f,rect.top+(rect.bottom - rect.top)/2f,10.toPx().toFloat(),paint)
        }
