package com.phz.common.ext.sharepreference
...
/**
 * @author phz
 * @description sp用来存取轻量级的数据
 */
/**
 * Get the Editor instance and commit/apply
 * @param commit if true , use [SharedPreferences.Editor.commit], otherwise use [SharedPreferences.Editor.apply]
