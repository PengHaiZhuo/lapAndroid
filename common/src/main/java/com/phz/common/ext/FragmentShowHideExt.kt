...
/**
 * @author phz
 * @description 扩展Fragment及Activity,使用add+show+hide模式下的Fragment的懒加载
 * 注意：当调用 Fragment.showHideFragment ，确保已经先调用 Fragment.loadFragments
 * 注意：当调用 FragmentActivity.showHideFragment，确保已经先调用 FragmentActivity.loadFragments
 */
/**
 * 加载根Fragment
